      ...
      <div className={cn("flex-none relative h-full", className)}>
        ...
        <div className="absolute inset-0 z-5 flex items-center justify-center lg:hidden">
          <a
            ...
            className="from-natgeo-yellow to-natgeo-yellow hoverable-link border-natgeo-yellow border-b-2 bg-linear-to-r px-2 py-1 inline-block text-xl font-bold text-black [@media(hover:hover)]:hover:border-transparent [@media(hover:hover)]:hover:text-black mb-2 mt-2"
          >
        ...
        <div className="hidden lg:block">
          ...
          <div className="flex flex-1 flex-col justify-start space-y-1 p-3">
            ...
            <div className="absolute bottom-2 right-2 flex items-center gap-2 ">
              ...
              />
              <ShareLink
                className="cursor-pointer transform transition-transform duration-300 [@media(hover:hover)]:hover:scale-110"
                shareData={{
                  title: name,
                  url: obituaryUrl,
                }}
      ...
      >
        ...
        {showFlip && (
          ...
          >
            <button
              type="button"
              className="absolute top-2 right-1 rounded-full [@media(hover:hover)]:hover:scale-115 cursor-pointer transition"
            ...
            {youtubeLink && (
              <a
                ...
                className="flex items-center justify-center gap-2 bg-red-600 [@media(hover:hover)]:hover:bg-red-700 text-white text-base py-2 w-full mt-2"
