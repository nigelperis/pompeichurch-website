...
export const ui = {
	...
	kok: {
		...
		'nav.parish-pastoral-commissions': '21 ಆಯೋಗ್',
		...
		'priest.bernardsouza':'ಮಾ| ಬಾ| ಬರ್ನಾರ್ಡ್  ಡಿಸೋಜಾ',
		'priest.graciandsouza':'ಮಾ| ಬಾ| ಗ್ರೇಶನ್ ಡಿಸೋಜಾ',
