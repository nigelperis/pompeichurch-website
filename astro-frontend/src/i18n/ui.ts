...
export const ui = {
  en: {
    ...
    "achievement.warm-wishes": "With Warmest Wishes,",
    "achievement.achievement-type": "Achievement Type",
    "achievement.achievement-type-error": "Please select an achievement type.",
    "achievement.full-name": "Full Name",
    "achievement.team-name": "Team Name",
    achievement: "Achievement",
    "achievement.achiever-image": "Achiever Image",
    "achievement.issue-date": "Achievement Issue Date",
    "achievement.individual-achievement": "Individual Achievement",
    "achievement.team-achievement": "Team Achievement",
    "achievement.choose-file": "Choose file",
    "achievement.choose-files": "Choose file(s)",
    "achievement.parents-names": "Parents Names",
    "achievement.team-members-names": "Team Members Names",
    "achievement.ward": "Ward",
    "achievement.submitted-by": "Submitted By",
    "achievement.proof-of-achievement": "Proof of Achievement",
    "achievement.additional-images": "Additional Images (only 2 if any)",
    "achievement.files": "Files",
    "achievement.no-file-chosen": "No file chosen",
    "achievement.no-files-chosen": "No file(s) chosen",
    "achievement.submit": "Submit",
    "achievement.image-size-error": "Please select an image less than 2MB.",
    ...
    "placeholder.parents-names": "Ex: John Doe and Jane Doe",
    "placeholder.team-members-names": "Ex: John, Sam, Jane",
    "placeholder.submitted-by": "Ex: John Doe",
    "achievement.form-submission": "Parishioners Achievements Submission Form",
  ...
  kok: {
    ...
    "achievement.warm-wishes": "ಸರ್ವ್ ಬೊರೆಂ ಮಾಗ್ತಾತ್,",
    "achievement.achievement-type": "ಸಾಧನಾಚೊ ಪ್ರಕಾರ್",
    "achievement.achievement-type-error": "ದಯಾಕರ್ನ್ ತುಮ್ಚಿ ವಿಂಚವ್ಣ್ ಕರಾ.",
    "achievement.full-name": "ನಾಂವ್",
    "achievement.team-name": "ಪಂಗ್ಡಾಚೆಂ ನಾಂವ್",
    achievement: "ಸಾಧನ್",
    "achievement.achiever-image": "ಸಾಧನ್ಗಾರಾಚಿ ತಸ್ವೀರ್",
    "achievement.issue-date": "ಸಾಧನ್ ಪರ್ಗಟ್ಣೆಚಿ ತಾರೀಕ್",
    "achievement.individual-achievement": "ವೈಯುಕ್ತಿಕ್ ಸಾಧನ್",
    "achievement.team-achievement": "ಪಂಗ್ಡಾಚೆಂ ಸಾಧನ್",
    "achievement.choose-file": "ತಸ್ವೀರ್ ವಿಂಚಾ",
    "achievement.choose-files": "ತಸ್ವೀರ್(ರೊ) ವಿಂಚಾ",
    "achievement.parents-names": "ಆವಯ್‌ ಬಾಪಯ್ಚೆಂ ನಾಂವ್",
    "achievement.team-members-names": "ಪಂಗ್ಡಾಚ್ಯಾ ಸಾಂದ್ಯಾಂಚಿಂ ನಾಂವಾಂ",
    "achievement.ward": "ವಾಡೊ",
    "achievement.submitted-by": " ಅರ್ಜಿದಾರಕ್",
    "achievement.proof-of-achievement": "ಸಾಧನಾಚಿ ರುಜ್ವಾತ್",
    "achievement.additional-images": "ಹೆರ್ ತಸ್ವಿರೊ (ಆಸಾತ್ ಜಾಲ್ಯಾರ್ ಕೇವಲ್ 2)",
    "achievement.files": "ತಸ್ವಿರೊ",
    ...
    "achievement.form-submission": "ಫಿರ್ಗಜ್ಗಾರಾಂಚ್ಯಾ ಸಾಧನಾಂಚಿ ಅರ್ಜಿ",
    "achievement.lang-change": "ಭಾಷೆ ಬದಲಾವಣೆ",
