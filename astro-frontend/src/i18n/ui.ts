...
export const ui = {
	en: {
		...
		'nav.parish-pastoral-commissions': 'Parish Pastoral 21 Commissions',
		...
		'nav.ycs': 'YCS',
		'nav.secular-franciscan': 'Secular Franciscan (Third Order)',
		'nav.catechism': 'Catechism',
		'nav.small-christian-community': 'Small Christian Community',
		'nav.gurpur-choir': 'Gurpur Choir',
		...
		'landing.pastoral-commissions-coordinator':
		...
		'landing.pastoral-commissions-coordinator-name': 'Mrs. Hilda Menezes',
		'landing.about-church': 'ABOUT POMPEI CHURCH',
		'landing.pastoral-council': 'Parish Pastoral Council',
		...
		'priest.bernardsouza':'Rev. Fr. Bernard DSouza',
		'priest.graciandsouza':'Rev. Fr. Gracian DSouza',
		'priest.stanyperiera':'Rev. Fr. Stany Pereira',
	...
	kok: {
		...
		'nav.parish-pastoral-council': 'ಗೊವ್ಳಿಕ್ ಪರಿಷಧ್',
		'nav.parish-pastoral-commission': '21 ಆಯೋಗ್',
		...
		'nav.ycs': 'ವೈ.ಸಿ.ಎಸ್.',
		'nav.secular-franciscan': 'ತಿಸ್ರಿ ಓಡ್ದ್  (ಸೆಕುಲರ್ ಫ್ರಾನ್ಸಿಸ್ಕನ್)',
		...
		'nav.events': 'ಕಾರ್ಯಕ್ರಮಾಂ',
		'nav.pompeichen-falkem': 'ಪೊಂಪೈಚೆಂ ಫಾಲ್ಕೆಂ',
		...
		'landing.pastoral-commissions-coordinator': '21 ಆಯೋಗ್ ಸಂಯೋಜಕಿ',
		'landing.priest-speaks': 'ಫಿರ್ಗಜ್ ವಿಗಾರ್ ಉಲಯ್ತಾ',
		'landing.priest-name': 'ಬೊ|ಮಾ|ಬಾ| ರುಡೋಲ್ಫ್ ರವಿ ಡೆಸಾ',
		'landing.vp-name': 'ಶ್ರೀಮಾನ್ ರೋಮನ್ಸ್ ಲೋಬೊ',
		'landing.secretary-name': 'ಶ್ರೀಮಾನ್ ಜೊನ್ಸನ್ ಲೋಬೊ',
		'landing.pastoral-commissions-coordinator-name': 'ಶ್ರೀಮತಿ ಹಿಲ್ಡಾ ಮಿನೇಜಸ್',
		'landing.about-church': 'ಆಮ್ಚ್ಯಾ ಫಿರ್ಗಜೆಚಿ ಮಾಹೆತ್',
		'landing.pastoral-council': 'ಫಿರ್ಗಜ್ ಗೊವ್ಳಿಕ್ ಪರಿಷಧ್',
		...
		'landing.friday-note': 'ದೈವಿಕ್ ಕಾಕುಳ್ತಿಚಿ ತೇರ್ಸ್ ಆನಿಂ ಮೀಸ್',
		'landing.saturday': 'ಸನ್ವಾರಾ',
		'landing.saturday-note': 'ಆಯ್ತಾರಾಚಿ ದೇವ್ ಸ್ತುತಿ',
		'landing.sunday': 'ಆಯ್ತಾರಾ',
		'landing.sunday-note':'ಸಾಕ್ರಾಮೆಂತಾಚೆಂ ಆರಾಧನ್ ಮಹಿನ್ಯಾಚಾ ಪಯ್ಲ್ಯಾ ಆಯ್ತಾರಾ ಸಕಾಳಿಂ ಮಿಸಾ ಉಪ್ರಾಂತ್',
		...
		'priest.fxnazreth':'ಮಾ| ಬಾ| ಎಫ್. ಎಕ್ಸ್. ನಜರೆತ್',
		'priest.raphaelpinto':'ಮಾ| ಬಾ| ರಫಾಯೆಲ್ ಪಿಂಟೊ',
		'priest.avelinerebello':'ಮಾ| ಬಾ| ಆವೆಲಿನ್ ರೆಬೆಲ್ಲೊ',
		'priest.ajnazreth':'ಮಾ| ಬಾ| ಎ.ಜೆ. ನಜ್ರೆತ್',
		'priest.johncastelino':'ಮಾ| ಬಾ| ಜೊನ್ ಕಾಸ್ತೆಲಿನೊ',
		'priest.jstrodrigues':'ಮಾ| ಬಾ| ಜೆ. ಎಸ್. ಟಿ. ರೊಡ್ರಿಗಸ್',
		'priest.bernardsouza':'ಮಾ| ಬಾ| ಬರ್ನಾರ್ಡ್ ಡಿ ಸೋಜಾ',
		'priest.graciandsouza':'ಮಾ| ಬಾ| ಗ್ರೇಶನ್ ಡಿ ಸೋಜಾ',
		'priest.stanyperiera':'ಮಾ| ಬಾ| ಸ್ಟ್ಯಾನಿ ಪಿರೇರ್',
