...
export const ui = {
  en: {
    ...
    submit: "Submit",
    preview: "Preview",
    toastMsg: "Your submission was successful! The obituary will be added shortly. Please check the obituary page soon.",
    spam: "Spam detected.",
  ...
  kok: {
    ...
    submit: "ದಾಖಲ್ ಕರಾ",
    preview: "ಪ್ರಿವ್ಯೂ",
    toastMsg: "ತುಮ್ಚಿ ಅರ್ಜಿ ಆಮ್ಕಾ ಪಾವ್ಲ್ಯಾ! ದಯಾಕರ್ನ್ ಥೊಡ್ಯಾ ವೆಳಾನ್ ಶ್ರದ್ಧಾಂಜಲಿ ಪಾನ್ ಪೊಳೆಯಾ.",
    spam: "Spam detected.",
