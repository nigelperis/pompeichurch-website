...
export const ui = {
  en: {
    ...
    image: "Upload Image",
    imageHelp: "* Image should be less than 500KB, .jpg/.png only",
    submit: "Submit",
    preview: "Preview",
  ...
  kok: {
    ...
    nameEnPH: "Enter ನಾಂವ್ in English",
    nameKok: "ನಾಂವ್ (ಕೊಂಕಣಿ)",
    nameKokPH: "Enter ನಾಂವ್ in ಕೊಂಕಣಿ",
    age: "ಪ್ರಾಯ್",
    agePH: "Enter ಪ್ರಾಯ್",
    ward: "ವಾಡೊ",
    wardPH: "Select ವಾಡೊ",
    death: "ಮರಣ್",
    relType: "ಸಂಬಂಧ್ ಕಿತೆಂ",
    relTypePH: "Select ಸಂಬಂಧ್",
    relNameEn: "ಸಂಬಂಧ್ ನಾಂವ್ (English)",
    relNameEnPH: "Enter ಸಂಬಂಧ್ ನಾಂವ್ in English",
    relNameKok: "ಸಂಬಂಧ್ ನಾಂವ್ (ಕೊಂಕಣಿ)",
    relNameKokPH: "Enter ಸಂಬಂಧ್ ನಾಂವ್ in ಕೊಂಕಣಿ",
    sender: "ತುಜೆ ನಾಂವ್",
    senderPH: "Enter Your ನಾಂವ್",
    image: "ತಸ್ವಿರ್ ಅಪ್ಲೋಡ್ ಕರ್",
    imageHelp: "* ತಸ್ವಿರ್ 500KBಚ ಕಿ ಉಣೆ ಆಸಜೆ, .jpg/.png only",
    submit: "ದಾಖಲ್ ಕರ್",
    preview: "ಪ್ರಿವ್ಯೂ",
