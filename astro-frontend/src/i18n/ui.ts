...
export const ui = {
	...
	kok: {
		...
		'nav.pompei-a-ward': 'ಪೊಂಪಯ್ ಎ',
		'nav.pompei-b-ward': 'ಪೊಂಪಯ್ ಬಿ',
		'nav.kandar-a-ward': 'ಕಂದಾರ್ ಎ',
		'nav.kandar-b-ward': 'ಕಂದಾರ್ ಬಿ',
		'nav.addoor-ward': 'ಅಡ್ಡೂರ್',
		'nav.obituary': 'ಫಿರ್ಗಜೆಂತ್ ಮರಣ್',
		'nav.events': 'ಘಡಿತಾಂ',
		'nav.pompeichem-falkem': 'ಪೊಂಪಯ್ಚೆಂ ಫಾಲ್ಕೆಂ',
		'nav.prayer-corner': 'ಮಾಗ್ಣ್ಯಾ ಪಾನ್',
		'nav.pompei-sabha-bhavan': 'ಪೊಂಪಯ್ ಸಭಾ ಭವನ್',
		'nav.centenary-hall': 'ಶತಾಬ್ದಿ ಸಾಲ್',
		'landing.church-name': 'ಪೊಂಪಯ್ ಮಾಯೆಚಿ ಫಿರ್ಗಜ್',
		...
		'landing.novena': 'ಪೊಂಪಯ್ ಮಾಯೆಚೆ‌ ನೊವೆನ್',
		...
		'history.subtitle': 'ಪೊಂಪಯ್ ಮಾಯೆಚಿ ಫಿರ್ಗಜ್, ಗುರ್ಪುರ್ - ಚರಿತ್ರೆಚೆರ್ ಏಕ್ ನದರ್',
		...
		'pompeiconvent.title': 'ಪೊಂಪಯ್ ಕೊವೆಂತ್ ',
		'rosamysticaconvent.title': 'ರೋಸಾ ಮಿಸ್ತಿಕಾ ಕೊವೆಂತ್',
		'hall.title': 'ಪೊಂಪಯ್ ಸಭಾ ಭವನ್',
		...
		'ward.pompei-a-ward': 'ಪೊಂಪಯ್ ಎ',
		'ward.pompei-b-ward': 'ಪೊಂಪಯ್ ಬಿ',
		...
		'ward.patron-pompei-a': 'ಪೊಂಪಯ್ ಮಾಯೆಕ್',
		...
		'prayer.novena-of-our-lady-of-pompei': 'ಪೊಂಪಯ್ ರೊಜಾರ್ ಸಾಯ್ಬಿಣಿಚೆಂ ನೊವೆನ್',
		'prayer.pray-for-us': 'ಪೊಂಪಯ್ ಮಾಯೆ ಆಮಾ ಪಾಸುನ್ ವಿನತಿ ಕರ್ ',
		...
		'priest.pompei-a': 'ಪೊಂಪಯ್ ಎ',
		'priest.pompei-b': 'ಪೊಂಪಯ್ ಬಿ',
		...
		'nun.pompei-a': 'ಪೊಂಪಯ್ ಎ',
		'nun.pompei-b': 'ಪೊಂಪಯ್ ಬಿ',
