...
export const ui = {
	en: {
		...
		'nav.parish-vocations': 'Parish Vocations',
		...
		'vpsec.term': 'Term',
		'vpsec.term1': 'First Term',
		'vpsec.term2': 'Second Term',
		...
		'vp.wilfredpinto': 'Late Wilfred Pinto',
		...
		'sec.wilfredpinto': 'Late Wilfred Pinto',
	...
	kok: {
		...
		'nav.parish-vocations': 'ಫಿರ್ಗಜಿಂತ್ಲಿ ಧಾರ್ಮಿಕಾಂ',
		...
		'vpsec.term': 'ಆವ್ದಿ',
		'vpsec.term1': 'ಪಯ್ಲಿ ಆವ್ದಿ',
		'vpsec.term2': 'ದುಸ್ರಿ ಆವ್ದಿ',
		'vp.georgepinto': 'ದೆ| ಜೊರ್ಜ್ ಪಿಂಟೊ',
		'vp.eliasrodrigues': 'ದೆ| ಎಲ್ಯಾಸ್ ರೊಡ್ರಿಗಸ್',
		'vp.jeraldrasquinha': 'ಶ್ರೀಮಾನ್ ಜೆರಾಲ್ಡ್ ರಸ್ಕಿನ್ಹಾ',
		'vp.richardlobo': 'ಶ್ರೀಮಾನ್ ರಿಚ್ಚರ್ಡ್ ಲೋಬೊ',
		'vp.wilfredpinto': 'ದೆ| ವಿಲ್ಫ್ರೆಡ್ ಪಿಂಟೊ',
		'vp.johnsonlobo': 'ಶ್ರೀಮಾನ್ ಜೊನ್ಸನ್ ಲೋಬೊ',
		'vp.romanslobo': 'ಶ್ರೀಮಾನ್ ರೋಮನ್ಸ್ ಲೋಬೊ',
		'vp.richardfernandes': 'ದೆ| ರಿಚ್ಚರ್ಡ್ ಫೆರ್ನಾಂಡಿಸ್',
		'sec.term': 'ಆವ್ದಿ',
		'sec.term1': 'ಪಯ್ಲಿ ಆವ್ದಿ',
		'sec.term2': 'ದುಸ್ರಿ ಆವ್ದಿ',
		...
		'sec.wilfredpinto': 'ದೆ| ವಿಲ್ಫ್ರೆಡ್ ಪಿಂಟೊ',
