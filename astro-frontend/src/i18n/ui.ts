...
export const ui = {
  en: {
    ...
    "relation.S/O": "S/O",
    "relation.D/O": "D/O",
    "ward.Kowdoor A": "Kowdoor A",
    "ward.Kowdoor B": "Kowdoor B",
    "ward.Monel": "Monel",
    "ward.Gurpur": "Gurpur",
    "ward.Church": "Church",
    "ward.Pompei A": "Pompei A",
    "ward.Pompei B": "Pompei B",
    "ward.Kandar A": "Kandar A",
    "ward.Kandar B": "Kandar B",
    "ward.Addoor": "Addoor",
  },
  kok: {
    "nav.home": "ಹೋಮ್",
    ...
    relNameEn: "Relation Name (English)",
    relNameEnPH: "Enter Relation Name in English",
    relNameKok: "Relation Name (ಕೊಂಕಣಿ)",
    relNameKokPH: "Enter Relation Name in Konkani",
    sender: "Sender's Name",
    senderPH: "Enter Your Name",
    image: "Upload Image",
    ...
    spam: "Spam detected.",
    imageError: "Image must be less than 500KB",
    funeralDetails: "ಮರ್ಣಾಚಿ ರೀತ್",
    "relation.H/O": "ಪತಿ",
    "relation.W/O": "ಪತಿಣ್:",
    "relation.S/O": "ಪುತ್",
    "relation.D/O": "ದುವ್ ",
    "ward.Kowdoor A": "ಕೌಡೂರ್ ಎ",
    "ward.Kowdoor B": "ಕೌಡೂರ್ ಬಿ",
    "ward.Pompei A": "ಪೊಂಪೈ ಎ",
    "ward.Pompei B": "ಪೊಂಪೈ ಬಿ",
    "ward.Kandar A": "ಕಂದಾರ್ ಎ",
    "ward.Kandar B": "ಕಂದಾರ್ ಬಿ",
    "ward.Church": "ಇಗರ್ಜೆ",
    "ward.Monel": "ಮೋನೆಲ್",
    "ward.Gurpur": "ಗುರ್ಪುರ್",
    "ward.Addoor": "ಅಡ್ಡೂರ್",
  },
} as const;
