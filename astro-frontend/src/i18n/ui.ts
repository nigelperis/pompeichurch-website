...
export const ui = {
  en: {
    ...
    anniversaryMessage: "Whatever God created, He saw that it was good, and He was truly pleased. The parish website we created has also turned out well, and on its first anniversary, we are filled with joy and gratitude. The website continues to share parish news, history, prayers, updates, and photos in an attractive and regularly refreshed format. We pray that this website may always remain vibrant and inspiring.",
  ...
  kok: {
    ...
    anniversaryMessage: "ದೆವಾನ್‌ ರಚ್ಲೆಂ ಸಗ್ಳೆಂ ತಾಕಾ ಬರೆಂ ದಿಸ್ಲೆಂ ಆನಿ ತೊ ಖರೆಂಚ್‌ ಸಂತೊಸ್ಲೊ. ಆಮಿಂ ರಚ್ಲಲಿ ಫಿರ್ಗಜೆಚಿ ವೆಬ್‌ಸಾಯ್ಟ್ ಆಮ್ಕಾಂ ಬರಿಂ ದಿಸ್ಲಿಂ ಆನಿ ತಾಚ್ಯಾ ಪಯ್ಲ್ಯಾ ವರ್ಸಾಚ್ಯಾ ಸುವಾಳ್ಯಾರ್‌ ವರ್ತೊ ಸಂತೊಸ್‌ ಆಮ್ಕಾಂ ಭೊಗ್ತಾ. ಫಿರ್ಗಜೆಚ್ಯೊ ನಿರಂತರ್‌ ಖಬ್ರೊ, ಚರಿತ್ರಾ, ಮಾಗ್ಣೆಂ, ವರ್ದಿ, ತಸ್ವಿರೊ ಆಟಾಪ್ಟಿಂ ಪಾನಾ, ಆಕರ್ಶಿತ್‌ ಆನಿ ನವಿಕರಣಾಚ್ಯಾ ಪಾವ್ಲಾಂನಿ ಚಮ್ಕೊಂವ್ಚಿ ವೆಬ್‌ಸಾಯ್ಟ್ ಅಶಿಚ್ಚ್‌ ಸದಾಂಚ್‌ ಸುಡ್ಸುಡಿತ್ ಆಸುಂದಿ ಮ್ಹಣ್‌ ಮಾಗ್ತಾಂ.",
