...
export const ui = {
	...
	kok: {
		...
		'nav.pompei-a-ward': 'ಪೊಂಪೈ್ ಎ',
		'nav.pompei-b-ward': 'ಪೊಂಪೈ್ ಬಿ',
		'nav.kandar-a-ward': 'ಕಂದಾರ್ ಎ',
		'nav.kandar-b-ward': 'ಕಂದಾರ್ ಬಿ',
		'nav.addoor-ward': 'ಅಡ್ಡೂರ್',
		'nav.obituary': 'ಫಿರ್ಗಜೆಂತ್ ಮರಣ್',
		'nav.events': 'ಘಡಿತಾಂ',
		'nav.pompeichem-falkem': 'ಪೊಂಪೈ್ಚೆಂ ಫಾಲ್ಕೆಂ',
		'nav.prayer-corner': 'ಮಾಗ್ಣ್ಯಾ ಪಾನ್',
		'nav.pompei-sabha-bhavan': 'ಪೊಂಪೈ್ ಸಭಾ ಭವನ್',
		'nav.centenary-hall': 'ಶತಾಬ್ದಿ ಸಾಲ್',
		'landing.church-name': 'ಪೊಂಪೈ್ ಮಾಯೆಚಿ ಫಿರ್ಗಜ್',
		...
		'landing.novena': 'ಪೊಂಪೈ್ ಮಾಯೆಚೆ‌ ನೊವೆನ್',
		...
		'history.subtitle': 'ಪೊಂಪೈ್ ಮಾಯೆಚಿ ಫಿರ್ಗಜ್, ಗುರ್ಪುರ್ - ಚರಿತ್ರೆಚೆರ್ ಏಕ್ ನದರ್',
		...
		'pompeiconvent.title': 'ಪೊಂಪೈ್ ಕೊವೆಂತ್ ',
		'rosamysticaconvent.title': 'ರೋಸಾ ಮಿಸ್ತಿಕಾ ಕೊವೆಂತ್',
		'hall.title': 'ಪೊಂಪೈ್ ಸಭಾ ಭವನ್',
		...
		'ward.pompei-a-ward': 'ಪೊಂಪೈ್ ಎ',
		'ward.pompei-b-ward': 'ಪೊಂಪೈ್ ಬಿ',
		...
		'ward.patron-pompei-a': 'ಪೊಂಪೈ್ ಮಾಯೆಕ್',
		...
		'prayer.novena-of-our-lady-of-pompei': 'ಪೊಂಪೈ್ ರೊಜಾರ್ ಸಾಯ್ಬಿಣಿಚೆಂ ನೊವೆನ್',
		'prayer.pray-for-us': 'ಪೊಂಪೈ್ ಮಾಯೆ ಆಮಾ ಪಾಸುನ್ ವಿನತಿ ಕರ್ ',
		...
		'priest.pompei-a': 'ಪೊಂಪೈ್ ಎ',
		'priest.pompei-b': 'ಪೊಂಪೈ್ ಬಿ',
		...
		'nun.pompei-a': 'ಪೊಂಪೈ್ ಎ',
		'nun.pompei-b': 'ಪೊಂಪೈ್ ಬಿ',
