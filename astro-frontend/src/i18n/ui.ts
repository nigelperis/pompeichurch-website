...
export const ui = {
  en: {
    ...
    "magazine.edition.easter": "Easter Edition",
    "magazine.edition.monti": "Monti Feast Edition",
    "magazine.edition.christmas": "Christmas Edition",
    ...
    "pagination.page-placeholder": "Page",
    "pagination.go-button": "Go",
    "pagination.page-input-label": "Go to page number",
    "pagination.required-field": "Please fill out this field.",
    "pagination.invalid-number": "Please enter a valid number.",
    "pagination.invalid-page": "This page doesn't exist",
    ...
    "prayer.holy-spirit": "Prayer to the Holy Spirit",
  ...
  kok: {
    ...
    "magazine.edition.easter": "ಪಾಸ್ಕಾಂ ಫೆಸ್ತಾಚೊ ಅಂಕೊ",
    "magazine.edition.monti": "ಮೊಂತಿ ಫೆಸ್ತಾಚೊ ಅಂಕೊ",
    "magazine.edition.christmas": "ನತಲಾಂ ಫೆಸ್ತಾಚೊ ಅಂಕೊ",
    ...
    "pagination.page-placeholder": "ಪಾನ್",
    "pagination.go-button": "ವಚಾ",
    "pagination.page-input-label": "ಹ್ಯಾ ಪಾನಾಕ್ ವಚಾ",
    "pagination.required-field": "ದಯಾಕರ್ನ್ ಹೊ ಕ್ಷೇತ್ರ್ ಭರ್ತಿ ಕರಾ.",
    "pagination.invalid-number": "ದಯಾಕರ್ನ್ ಜೊಕ್ತೊ ಅಂಕ್ಡೊ ಘಾಲಾ.",
    "pagination.invalid-page": "ಹೊ ಪಾನ್ ಲಭ್ಯ್ ನಾ",
    ...
    "prayer.holy-spirit": "ಪವಿತ್ರ್ ಅತ್ಮ್ಯಾಕ್ ಮಾಗ್ಣೆಂ",
