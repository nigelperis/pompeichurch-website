...
export const ui = {
  en: {
    ...
    "nav.obituary-form": "Submit an Obituary",
    "nav.events": "Events",
    ...
    obituaryPageTitle: "Submit an Obituary",
    nameEn: "Full Name (English)",
    nameEnPH: "Enter Name in English",
    nameKok: "Full Name (Konkani)",
    nameKokPH: "Enter Name in Konkani",
    age: "Age",
    agePH: "Enter Age",
    ward: "Ward",
    wardPH: "Select Ward",
    ...
    relTypePH: "Select Relation",
    relNameEn: "Relation Name (English)",
    relNameEnPH: "Enter Relation Name in English",
    relNameKok: "Relation Name (Konkani)",
    relNameKokPH: "Enter Relation Name in Konkani",
    sender: "Sender's Name",
    senderPH: "Enter Your Name",
    image: "Upload Image",
    imageHelp: "* Image must be under 500KB and in .jpg, .jpeg, or .png format",
    submit: "Submit",
    preview: "Preview",
    toastMsg:
      "Your submission was successful! The obituary will be added shortly. Please check the obituary page soon.",
    spam: "Spam detected.",
    imageError: "Image must be less than 500KB",
    wifeOf: "Wife of",
  ...
  kok: {
    ...
    "nav.obituary-form": "ಶ್ರದ್ಧಾಂಜಲಿ ಅರ್ಜಿ",
    "nav.events": "ಘಡಿತಾಂ",
    ...
    obituaryPageTitle: "ಶ್ರದ್ಧಾಂಜಲಿ ಅರ್ಜಿ",
    nameEn: "ನಾಂವ್ (English)",
    nameEnPH: "ಇಂಗ್ಲಿಷಾಂತ್ ನಾಂವ್ ಭರ್ತಿ ಕರಾ",
    nameKok: "ನಾಂವ್ (ಕೊಂಕಣಿ)",
    nameKokPH: "ಕೊಂಕ್ಣೆಂತ್ ನಾಂವ್ ಭರ್ತಿ ಕರಾ",
    age: "ಪ್ರಾಯ್",
    agePH: "ಪ್ರಾಯ್ ಭರ್ತಿ ಕರಾ",
    ward: "ವಾಡೊ",
    wardPH: "ವಾಡೊ ಭರ್ತಿ ಕರಾ",
    death: "ಮರಣ್",
    relType: "ತುಮ್ಚೊ ಸಂಬಂಧ್ ಕಿತೆಂ",
    relTypePH: "ಸಂಬಂಧ್ ಭರ್ತಿ ಕರಾ",
    relNameEn: "ಸಂಬಂಧಿಕಾಚೆ ನಾಂವ್ (English)",
    relNameEnPH: "ಇಂಗ್ಲಿಷಾಂತ್ ಸಂಬಂಧಿಕಾಚೆ ನಾಂವ್ ಭರ್ತಿ ಕರಾ",
    relNameKok: "ಸಂಬಂಧಿಕಾಚೆ ನಾಂವ್ (ಕೊಂಕಣಿ)",
    relNameKokPH: "ಕೊಂಕ್ಣೆಂತ್ ಸಂಬಂಧಿಕಾಚೆ ನಾಂವ್ ಭರ್ತಿ ಕರಾ",
    sender: "ತುಮ್ಚೆ ನಾಂವ್",
    senderPH: "ತುಮ್ಚೆ ನಾಂವ್ ಭರ್ತಿ ಕರಾ",
    image: "ತಸ್ವೀರ್ ಅಪ್ಲೋಡ್ ಕರ್",
    imageHelp: "* ತಸ್ವೀರ್ 500KBಚ ಕಿ ಉಣೆ ಆಸಾಜೆ, .jpg / .jpeg ಯಾ .png ಮಾತ್ರ್",
    submit: "ದಾಖಲ್ ಕರಾ",
    preview: "ಪ್ರಿವ್ಯೂ",
    toastMsg:
      "ತುಮ್ಚಿ ಅರ್ಜಿ ಆಮ್ಕಾ ಪಾವ್ಲ್ಯಾ! ದಯಾಕರ್ನ್ ಥೊಡ್ಯಾ ವೆಳಾನ್ ಶ್ರದ್ಧಾಂಜಲಿ ಪಾನ್ ಪೊಳೆಯಾ.",
    spam: "Spam detected.",
    imageError: "ತಸ್ವೀರ್ 500KBಚ ಕಿ ಚಡ್ ಆಸಾ",
    wifeOf: "ಪತಿಣ್",
    husbandOf: "ಪತಿ",
    sonOf: "ಪೂತ್",
    daughterOf: "ಧುವ್",
