...
export const ui = {
	...
	kok: {
		...
		'landing.pastoral-parishad': 'ಫಿರ್ಗಜ್ ಗೊವ್ಳಿಕ್ ಪರಿಷಧ್',
		'landing.mass-timings': 'ಇಗರ್ಜೆಂತ್ ದೇವ್ ಸ್ತುತಿ',
		'landing.mass-timings-note': 'ಹರ್ಯೆಕ್ ಮಿಸಾಂ ಕೊಂಕ್ಣೆಂತ್ ಆಸ್ತಲಿಂ',
		...
		'landing.catechism-note': 'ಆಯ್ತಾರಾ, 9:15AM  (ಮಹಿನ್ಯಾಚೊ ಪಯ್ಲೊ ಆಯ್ತಾರ್  ಸೊಡ್ನ್ )',
