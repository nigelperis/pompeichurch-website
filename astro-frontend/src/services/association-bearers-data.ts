...
import type {
  ...
  AssociationOfficeBearersData,
} from "~/models/association-bearers";
 ...
 */
async function fetchAssociationBearers(
  locale: Locale = Locale.EN,
): Promise<AssociationOfficeBearers | null> {
  ...
  const data = await strapiFetch<AssociationOfficeBearersData>({
    endpoint: ROUTES.ASSCIATION_OFFICE_BEARERS,
    queryParams,
  });
